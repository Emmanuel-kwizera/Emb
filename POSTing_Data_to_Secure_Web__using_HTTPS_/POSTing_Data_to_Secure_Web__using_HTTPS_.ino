...
const char* host = "filesharing.benax.rw"; //domain or subdomain of your website
...
void setup(){
  ...
  connectToWiFi("RAC_WIFI", "rca@2019");
...
void operateData(byte blockNumber, String initialBalance){
  ...
  */
  ...
  if(saveBalanceToCard(blockNumber, (unsigned char *)writingBuffer)==true){
    ...
    connectToHost("e2f9258951d45d0aadad9780effc76799157e3e3", 443);
//      connectToHost("0f2acf70aaf3ae3a6c46eab04cd6540ad33d5edc", 443);

    transferData(mData, "/f/o/r/e/a/c/h/s/h/a/r/e/d/iot/postRFIDTransactions.php");   
